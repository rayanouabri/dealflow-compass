...
Réponds UNIQUEMENT avec du JSON valide.`;
      ...
      const aiBody = AI_PROVIDER === "vertex"
        ? {
            ...
            generationConfig: { temperature: 0.1, topP: 0.9, topK: 40, maxOutputTokens: 16384 },
          }
        : {
            contents: [{ parts: [{ text: `${systemPromptAnalyze}\n\n${userPromptAnalyze}` }] }],
            generationConfig: { temperature: 0.1, topP: 0.9, topK: 40, maxOutputTokens: 16384, responseMimeType: "application/json" as const },
          };
